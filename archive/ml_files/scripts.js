...
const projectId = findGetParameter("projectId");
const trainingApiKey = findGetParameter("trainingApiKey");
const predictionApiKey = findGetParameter("predictionApiKey");
...
function setupUIForMode(mode) {
    ...
    else if(mode == "play" && projectId && predictionApiKey) {
        $('#tag-selector').hide();
